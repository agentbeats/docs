...
AgentBeats is an open platform for Agentified Agent Assessment (AAA), focused on open, standardized, and reproducible evaluation for real-world agents.
It provides a unified evaluation interface based on A2A and MCP, supports multi-agent assessments natively, and helps reduce test-production mismatch.
...
-   **🚀 Visit Website**
    ...
    Product site, updates, and community resources.

    [Open Website](https://agentbeats.dev/)

-   **📘 Read Paper**

    ---

    Official arXiv page for AAA and evaluation details.

    [Open arXiv](https://arxiv.org/abs/2606.13608)

-   **🎤 ICML Poster**

    ---

    ICML 2026 virtual poster entry and publication context.

    [Open Poster Page](https://icml.cc/virtual/2026/poster/67210)

-   **🐞 Give Feedback**

    ---

    Report issues, suggest improvements, and discuss documentation updates.

    [Open GitHub Issues](https://github.com/agentbeats/docs/issues)
...
```bibtex
@article{liu2026agentbeats,
  title={AgentBeats: Agentifying Agent Assessment for Openness, Standardization, and Reproducibility},
  author={Liu, Xiaoyuan and Tu, Jianhong and Chen, Yuqi and Xie, Siyuan and Ren, Sihan and Shi, Tianneng and Gantar, Gal and Sandoval, Evan and Lee, Donghyun and Miao, Daniel and others},
...
-   **🏆 AgentX-AgentBeats Competition**
    ...
    Open competition track for agent assessment and benchmarking.

    [Open Competition](https://rdi.berkeley.edu/agentx-agentbeats)

-   **🔐 Secure-Agent CTF**

    ---

    Security-focused challenge environment for robust agent behavior.

    [Enter CTF Portal](https://ctf.secure-agent.com/)

</div>

## Blog Index

Start here if you are new to AgentBeats: read Blog 0 for the core AAA idea, then continue with implementation and integration posts.
If you are preparing a submission, Blog 2 and Blog 3 are the fastest path to hands-on setup.

1. [Blog 0: Agentified Agent Assessment (AAA) & AgentBeats](./Blogs/blog-0.md)
2. [Blog 1: What is AgentBeats and why should you care as an agent developer?](./Blogs/blog-1.md)
